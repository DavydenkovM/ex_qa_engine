defmodule ExQaEngineWeb.QuestionController do
  use ExQaEngineWeb, :controller

  alias ExQaEngine.Survey
  alias ExQaEngine.Survey.Question

  action_fallback ExQaEngineWeb.FallbackController

  def index(conn, params) do
    questions = Survey.list_questions(params)
    conn
    |> put_resp_header("x-total-count", "#{Survey.questions_count()}")
